      ...
      <Formik {...props} validationSchema={validationSchema}>
        <Form>
          <FormGroup className="mb-3">
            ...
            <Field name="rut" type="text" className="form-control" placeholder="Rut"/>
          ...
          <FormGroup className="mb-3">
            ...
            <ErrorMessage name="nombre" className="d-block invalid-feedback" component="span" />
          </FormGroup>
          <FormGroup className="mb-3">
            <label htmlFor="telefono">Telefono</label>
            <Field name="telefono" type="text" className="form-control" placeholder="Telefono"/>
